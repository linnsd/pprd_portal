...
class VillageShopController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      $fuel_types = DB::table('village_shops')
                 ->select('fuel_type')
                 ->groupBy('fuel_type')
                 ->get();
      // dd($fuel_types);
      ...
      return view('admin.village_shop.index',compact('shops','count','sdivisions','townships','fuel_types'));
    }
    ...
    public function create()
    {
      ...
      return view('admin.village_shop.create',compact('sdivisions','licences','townships','lic_grades'));
    }
    ...
    { 
      ...
      try {
        ...
        $res=VillageShop::create($arr);
          DB::commit();
      } catch (\Exception $e) {
        dd($e);
          DB::rollback();
          return redirect()->route('admin.village_shop.index')->with('error','Something went wrong!');
      }

      return redirect()->route('admin.village_shop.index')->with('success','Data create successfully');
    ...
    public function show($id)
    {
        ...
        $shop = VillageShop::find($id);
        return view('admin.village_shop.show',compact('shop'));
    ...
    public function edit($id)
    {
      ...
      return view('admin.village_shop.edit',compact('shop','sdivisions','townships','licences','lic_grades'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $shop = VillageShop::findOrFail($id);
        ...
        dd($e);
          DB::rollback();
          return redirect()->route('admin.village_shop.index')->with('error',$e->getMessage());
      }
      ...
      if(auth()->user()->role_id==2){
        ...
        return redirect()->route('admin.village_shop.index')->with('success','Data Update successfully');  
      }
    ...
    public function print($id)
    {
      ...
      return view('admin.village_shop.print',compact('shop','hashids'));
    }
    ...
    {
      $userid = auth()->user()->id;
      $shop = VillageShop::where('user_id',$userid)->get();
      $shop = $shop[0];
      return view('admin.village_shop.ownershop',compact('shop'));
    }
    ...
    public function signage()
    {
      ...
      $shop = VillageShop::where('user_id',$userid)->get();
      $shop = $shop[0];
      return view('admin.village_shop.signage',compact('shop'));
    }
    ...
    {
      $shop = VillageShop::findorfail($id);
      return view('admin.village_shop.print-signage',compact('shop'));
    ...
    public function saveCanvas(Request $request)
    {
        ...
        $shop = VillageShop::find($request->shop_id);
        $photo2 = $shop->photo2;
        $path = $shop->path;
    ...
    public function village_shop(Request $request)
    {
      $sdivisions = StateDivision::all();
