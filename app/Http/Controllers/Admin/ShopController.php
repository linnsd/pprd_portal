...
class ShopController extends Controller
{
    ...
    public function index(Request $request)
    {
      ...
      $shops = $data->orderBy('created_at','desc')->paginate(10);

      return view('admin.shops.index',compact('shops','count','sdivisions','townships','fuel_types'));
    }
    ...
    public function create()
    {
      ...
      return view('admin.shops.create',compact('sdivisions','licences','townships','lic_grades'));
    }
    ...
    { 
      ...
      try {
        ...
        $res=Shops::create($arr);
          DB::commit();
      } catch (\Exception $e) {
        dd($e);
          DB::rollback();
          return redirect()->route('admin.shops.index')->with('error','Something went wrong!');
      }

      return redirect()->route('admin.shops.index')->with('success','Data create successfully');
    ...
    public function edit($id)
    {
      ...
      return view('admin.shops.edit',compact('shop','sdivisions','townships','licences','lic_grades'));
    }
    ...
    public function update(Request $request, $id)
    {
      ...
      $shop = Shops::findOrFail($id);
        ...
        dd($e);
          DB::rollback();
          return redirect()->route('admin.shops.index')->with('error',$e->getMessage());
      }
      ...
      if(auth()->user()->role_id==2){
        ...
        return redirect()->route('admin.shops.index')->with('success','Data Update successfully');  
      }
    ...
    public function print($id)
    {
      ...
      return view('admin.shops.print',compact('shop','hashids'));
    }
    ...
    {
      $userid = auth()->user()->id;
      $shop = Shops::where('user_id',$userid)->get();
      $shop = $shop[0];
      return view('admin.shops.ownershop',compact('shop'));
    }
    ...
    public function signage()
    {
      ...
      $shop = Shops::where('user_id',$userid)->get();
      $shop = $shop[0];
      return view('admin.shops.signage',compact('shop'));
    }
    ...
    {
      $shop = Shops::findorfail($id);
      return view('admin.shops.print-signage',compact('shop'));
    ...
    public function village_shop(Request $request)
    {
      ...
      $count = $data->where('licence_id',2)->get()->count();

      $shops = $data->where('licence_id',2)->orderBy('created_at','desc')->paginate(10);
