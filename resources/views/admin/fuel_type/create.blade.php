...
<div class="container">
    <div class="panel-body">
        <form action="{{route('admin.fuel_types.store')}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label for="" class="form-label col-md-4">ဆီအမျိုးအစား*</label>
                             <div class="col-md-8">
                                <input type="text" placeholder="92 RON" name="fuel_type" value="" required class="form-control">
