...
<div class="container">
    <div class="panel-body">
        <form action="{{route('admin.notifications.update',$notification->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label for="" class="form-label col-md-4">အကြောင်းကြားချက်*</label>
                             <div class="col-md-8">
                                <input type="text" placeholder="အကြောင်းကြားချက်" name="title" value="{{$notification->title}}" required class="form-control">
                    ...
                    <div class="row">
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                <textarea class="form-control" placeholder="ဖော်ပြချက်" id="description" name="description">{{$notification->description}}</textarea>
                            </div>
                        </div>
                     ...
                     <div class="row">
                        <div class="form-group">
                            <label for="" class="form-label col-md-4">အကြောင်းကြားသည့်ရက်*</label>
                             <div class="col-md-8">
                                <input type="text" name="publish_date" id="publish_date" value="{{date('d-m-Y',strtotime($notification->publish_date))}}" class="form-control" placeholder="{{date('d-m-Y')}}" required>
