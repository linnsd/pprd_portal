...
<div class="container">
    <div class="panel-body">
        <form action="{{ route('admin.licence.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="licence_name" id="licence_name" placeholder="ရေနံထွက်ပစ္စည်းလုပ်ငန်းလိုင်စင်" value="{{ old('licence_name') }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="number" class="form-control" name="licence_price" id="licence_price" placeholder="4800000" value="{{ old('licence_price') }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="number" class="form-control" name="extend_price" id="extend_price" placeholder="2800000" value="{{ old('extend_price') }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                             <input type="number" id="expire_price" data-wcp-format="css" class="form-control" name="expire_price"  placeholder="96000" value="{{ old('expire_price') }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                             <input type="number" id="destroy_price" data-wcp-format="css" class="form-control" name="destroy_price"  placeholder="4800000" value="{{ old('destroy_price') }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                             <input type="number" id="change_owner" data-wcp-format="css" class="form-control" name="change_owner"  placeholder="14000000" value="{{ old('change_owner') }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                             <input type="number" id="upgrade_storage" data-wcp-format="css" class="form-control" name="upgrade_storage"  placeholder="480000" value="{{ old('upgrade_storage') }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                             <input type="number" id="change_name" data-wcp-format="css" class="form-control" name="change_name"  placeholder="480000" value="{{ old('change_name') }}"  />
