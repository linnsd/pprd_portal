...
<div class="container">
    <div class="panel-body">
        <form action="{{ route('admin.terminal.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="nrc" id="nrc" placeholder="9/PAMANA(N)111111" value="{{ old('nrc') }}"  />
...
ကျောက်တန်းမြို့နယ်" id="location" name="location"></textarea>
                ...
                <!-- <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="gasoline" id="gasoline" placeholder="200" value="{{ old('gasoline') }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="disel" id="disel" placeholder="200" value="{{ old('disel') }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="remark" id="remark" placeholder="" value="{{ old('remark') }}"  />
