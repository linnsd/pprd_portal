...
@section('content')
   ...
   <!--              <a class="btn btn-success btn-sm" href="{{route('shop.downloadqr',$shop->id)}}" style="margin-left: 15px;"><i class="fa fa-fw fa-download"></i>Download QR</a> -->
                <a class="btn btn-success btn-sm" target="_blank" href="{{ route('admin.machine_oil.print',$shop->id) }}"><i  class="fa fa-fw fa-print"></i> Print</a> 
                <a class="btn btn-primary btn-sm" href="{{ route('admin.machine_oil.index') }}"> <i  class="fa fa-fw fa-arrow-left"></i>နောက်သို့</a> 
            </div>
        </div>
    </div>
    <br>
                  ...
                  <table class="table table-bordered" style=" margin-right: auto; margin-left: auto;">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>{{ number_format($shop->gasoline) }} ဂါလန်</td>
                                  
                                </tr>
                                <tr>
                                  <th scope="row">ဒီဇယ်</th>
                                  <td>{{ number_format($shop->diesel) }} ဂါလန်</td>
