            ...
            <div class="row">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="company_name" id="company_name" placeholder="ABC Training Co.,Ltd" value="{{ old('company_name',$airport_oil->company_name) }}"  />
                        ...
                        <div class="col-md-5">
                           <select class="form-control" name="sd_id" id="sd_id">
                               ...
                               @foreach($statedivisions as $sd)
                                <option value="{{ $sd->id }}"
                                        {{ old('sd_id', $airport_oil->sd_id) == $sd->id ? 'selected' : '' }}>
                                        {{ $sd->sd_name }}
                                    </option>
                               @endforeach
                           </select>
...
ကျောက်တန်းမြို့နယ်" id="location" name="location">{{$airport_oil->location}}</textarea>
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="comp_licence_no" id="comp_licence_no" placeholder="0001" value="{{ old('comp_licence_no',$airport_oil->comp_lic_no) }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="comp_issue_date" id="comp_issue_date"  value="{{ old('comp_issue_date',$airport_oil->comp_issue_date) }}"   placeholder="2020-10-29" />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="licence_no" id="licence_no" placeholder="0001" value="{{ old('licence_no',$airport_oil->licence_no) }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        <h5 class="form-label col-md-2">ထုတ်ပေးသည့်ရက်စွဲ*</h5>
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="issue_date" id="issue_date"  value="{{ old('issue_date',$airport_oil->issue_date) }}"   placeholder="2020-10-29" />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="capacity" id="capacity" placeholder="200" value="{{ old('capacity',$airport_oil->capacity) }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="type" id="type" placeholder="200" value="{{ old('type',$airport_oil->type) }}"  />
