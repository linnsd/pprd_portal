...
<div class="container">
    <div class="panel-body">
        <form action="{{ route('admin.licence_fee.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="col-md-5">
                           <select class="itemName form-control" style="width:360px;" name="itemName"></select>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-8"> 
                               <select name="lic_grade_id" class="form-control">
                                   <option value="">Select licence grade</option>
                                   @foreach($lic_grades as $lic_grade)
                                   <option value="{{$lic_grade->id}}">{{$lic_grade->grade}}</option>
                                   @endforeach
                               </select>
                ...
                <div class="row" id="dynamicTable">
                    <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="text" class="form-control" name="lic_key[]" id="lic_key_id_1" placeholder="လိုင်စင်ကြေး" value="{{ old('lic_key') }}"  />
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input type="number" class="form-control" name="lic_value[]" id="lic_value_id_1" placeholder="500000" value="{{ old('lic_value') }}"  />
