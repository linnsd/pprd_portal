...
<div class="container">
    <div class="panel-body">
        <form action="{{ route('admin.township.store') }}" method="POST" class="form-horizontal">
            @csrf
            <div class="row">
                ...
                <div class="form-group {{ $errors->first('tsh_name_en', 'has-error') }}" >
                    ...
                    <div class="col-md-5">
                         <input type="text" name="tsh_name_en"  value="{{ old('tsh_name_en') }}" class="form-control"  placeholder="Pyinmana" >
                ...
                <div class="form-group {{ $errors->first('tsh_name_mm', 'has-error') }}" >
                    ...
                    <div class="col-md-5">
                         <input type="text" name="tsh_name_mm"  value="{{ old('tsh_name_mm') }}" class="form-control"  placeholder="ပျဉ်းမနား" >
                ...
                <div class="form-group {{ $errors->first('tsh_code', 'has-error') }}" >
                    ...
                    <div class="col-md-5">
                         <input type="text" name="tsh_code"  value="{{ old('tsh_code') }}" class="form-control"  placeholder="001" >
                        {!! $errors->first('tsh_code', '<span class="error_msg unicode">:message</span> ') !!}
                    </div>
             ...
             <div class="row">
                <div class="form-group {{ $errors->first('tsh_color', 'has-error') }}" >
                    ...
                    <div class="col-md-5">
                         <input type="text" id="color-css" data-wcp-format="css" name="tsh_color" class="form-control" placeholder="#acecff">
