...
@section('title', 'တိုင်းဒေသကြီး/ပြည်နယ် ပြင်ဆင်ရန် ')

@section('content_header')

    <h1>တိုင်းဒေသကြီး/ပြည်နယ် ပြင်ဆင်ရန်</h1>
...
<div class="container">
    <div class="panel-body">
        <form action="{{ route('admin.states-divisons.update',$data->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                 <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="sd_name" id="sd_name" placeholder="နေပြည်တော်" value="{{ old('sd_name',$data->sd_name) }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="sd_short" id="sd_short" placeholder="NPW" value="{{ old('sd_short',$data->sd_short) }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="mmr_code" id="mmr_code" placeholder="MMR001" value="{{ old('mmr_code',$data->mmr_code) }}"  />
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                             <input type="text" data-wcp-format="css" class="form-control" name="sd_color" id="color-css" placeholder="" value="{{ old('sd_color',$data->sd_color) }}"  />

                             <button type="btn" class="btn" style="background-color: {{ $data->sd_color }}"></button>
