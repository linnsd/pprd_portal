...
<div class="container">
    <div class="panel-body">
        <form action="{{ route('admin.sub_lic_gp.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="lic_sub_gp_name" id="lic_sub_gp_name" placeholder="ရေနံထွက်ပစ္စည်းလုပ်ငန်းလိုင်စင်" value="{{ old('lic_sub_gp_name') }}"  />
