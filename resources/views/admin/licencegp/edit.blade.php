...
<div class="container">
    <div class="panel-body">
        <form action="{{ route('admin.licence_gp.update',$licencegp->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row form-group">
                ...
                <div class="col-md-5">
                    <input type="text" class="form-control" name="licence_gp_name" id="licence_gp_name" placeholder="ရေနံထွက်ပစ္စည်းလုပ်ငန်းလိုင်စင်" value="{{ old('licence_gp_name',$licencegp->lic_gp_name) }}"/>
            ...
            <div class="row form-group">
                ...
                <div class="col-md-5">
                    <input type="text" class="form-control" name="prefix_code" id="prefix_code" placeholder="FS" value="{{ old('prefix_code',$licencegp->prefix_code) }}"  />
