...
@section('title', 'ကျေးရွာသုံးစက်သုံးဆီအရောင်းဆိုင်')

@section('content_header')

    <h1 class="unicode">ကျေးရွာသုံးစက်သုံဆီအရောင်းဆိုင်</h1>
...
@section('content')
    <div class="page_body">
        ...
        <div class="row">
            ...
            ?>
            <form action="{{ url('admin/village_shop') }}" method="get" accept-charset="utf-8" class="form-horizontal">
                <div class="row">
        ...
        @can('shop-create')
            ...
            <div class="row">
                <div class="form-group" align="right">
                    <a class="btn btn-success" href="{{ route('admin.village_shop.create') }}"><i class="fa fa-fw fa-plus"></i> အသစ်ထည့်ရန်</a>
                </div>
            </div>

            <div class="row">
                <form class="form-horizontal" action="{{ route('village_shop.import') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="form-group">
                       ...
                       <!--  <a class="btn btn-warning btn-sm" href="{{ route('village_shop.export') }}"><i class="fa fa-fw fa-file-excel-o"></i>Export</a> -->
                       <a class="btn btn-warning" id="export_btn"><i class="fa fa-fw fa-file-excel-o"></i>Export</a>
                         <a class="btn btn-primary btn-sm"  href="{{ route('village_shop.download.csv') }}"><i class="fa fa-fw fa-download"></i>Demo CSV File</a>
            ...
            <form id="excel_form" action="{{ route('village_shop.export') }}"  method="post">
            @csrf
                ...
                <table class="table table-bordered">
                    ...
                    <tr >
                        ...
                        <td>
                            ...
                            <form action="{{ route('admin.village_shop.destroy',$shop->id) }}" method="POST" onsubmit="return confirm('Do you really want to delete?');">
                                @csrf
                                @method('DELETE')
                                ...
                                <div class="dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        @can('shop-show')
                                            <li> 
                                                <a href="{{ route('admin.village_shop.show',$shop->id) }}"><i class="fa fa-fw fa-eye" title="အသေးစိတ်" /></i>Deatil</a>
                                            </li>
                                            <li class="divider"></li>
                                             @endcan
                                        @can('dio-full-permission')
                                            @can('shop-edit')
                                                <li>
                                                    <a title="ပြင်ရန်" href="{{ route('admin.village_shop.edit',$shop->id) }}"><i class="fa fa-fw fa-edit" /></i>Edit</a>
                                                </li>
                                                 <li class="divider"></li>
                                            @endcan
