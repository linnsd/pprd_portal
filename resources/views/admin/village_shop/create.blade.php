                       ...
                       <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="text" class="form-control" name="company_no" id="company_no" placeholder="123434" value="{{ old('company_no') }}"  />
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="number" class="form-control" name="ph_no" id="ph_no" placeholder="09123456789" value="{{ old('ph_no') }}"  />
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        <input type="email" class="form-control" name="email" id="email" placeholder="admin@gmail.com" value="{{ old('email') }}"  />
