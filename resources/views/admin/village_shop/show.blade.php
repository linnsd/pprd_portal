...
@section('content')
   ...
   <!--              <a class="btn btn-success btn-sm" href="{{route('shop.downloadqr',$shop->id)}}" style="margin-left: 15px;"><i class="fa fa-fw fa-download"></i>Download QR</a> -->
                <a class="btn btn-success btn-sm" target="_blank" href="{{ route('admin.village_shop.print',$shop->id) }}"><i  class="fa fa-fw fa-print"></i> Print</a> 
                <a class="btn btn-primary btn-sm" href="{{ route('admin.village_shop.index') }}"> <i  class="fa fa-fw fa-arrow-left"></i>နောက်သို့</a> 
            </div>
        </div>
    </div>
    <br>
                  ...
                  <table class="table table-bordered" style=" margin-right: auto; margin-left: auto;">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    @if($shop->township != null)
                                    {{ $shop->township->tsh_name_mm}}
                                    @endif
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    @if($shop->licence != null)
                                    {{ $shop->licence->lic_name}}
                                    @endif
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    @if($shop->gasoline != null)
                                    {{ number_format($shop->gasoline) }} ဂါလန်
                                    @endif
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    @if($shop->diesel != null)
                                    {{ number_format($shop->diesel) }} ဂါလန်
                                    @endif
                                  </td>
                                ...
                                <tr>
                                  ...
                                  <td>
                                    ...
                                    {{ number_format($shop->storage) }}  ဂါလန်
                                    @endif
                                  </td>
