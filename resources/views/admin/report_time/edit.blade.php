...
<div class="container">
    <div class="panel-body">
        <form action="{{route('admin.report_times.update',$report_time->id)}}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                        ...
                        <div class="form-group">
                            <label for="time">Report Time</label>
                              <div class="input-group date col-md-8" id="timePicker">
                                <input type="text" value="{{$report_time->rep_time}}" name="rep_time" class="form-control timePicker">
