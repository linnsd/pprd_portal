...
<div class="container">
    <div class="panel-body">
        <form action="{{ route('admin.licence_name.update',$licnames->id) }}" method="POST" class="form-horizontal" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="row">
                        ...
                        <div class="col-md-5">
                           <select class="form-control" name="lic_gp_id">
                               ...
                               @foreach($licencegps as $licencegp)
                                    ...
                                    <option value="{{ $licencegp->id }}"
                                        {{ old('lic_gp_id', $licnames->lic_gp_id) == $licencegp->id ? 'selected' : '' }}>
                                        {{ $licencegp->lic_gp_name }}
                                    </option>
                                  @endforeach
                           </select>
                        ...
                        <div class="col-md-5">
                           <select class="form-control" name="sub_lic_id">
                               ...
                               @foreach($sublicgps as $sublicgp)
                                    <option value="{{ $sublicgp->id }}"
                                        {{ old('sub_lic_id', $licnames->lic_sub_gp_id) == $sublicgp->id ? 'selected' : '' }}>
                                        {{ $sublicgp->lic_sub_gp_name }}
                                    </option>
                                  @endforeach
                           </select>
                ...
                <div class="row">
                    <div class="form-group">
                        <label for="" class="form-label col-md-2">လိုင်စင်ခွဲအမည်*</label>
                        <div class="col-md-5">
                            <input type="text" class="form-control" name="lic_name" id="lic_name" placeholder="ရေနံထွက်ပစ္စည်းလုပ်ငန်းလိုင်စင်" value="{{ old('lic_name',$licnames->lic_name) }}"  />
            ...
            <div class="row">
                <div class="form-group  text-center">
                    ...
                    <div class="col-md-5">
                        <a class="btn btn-primary" href="{{ route('admin.sub_lic_gp.index') }}"><i  class="fa fa-fw fa-arrow-left"></i>  နောက်သို့</a>
